  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft-lg': '0 10px 25px -3px rgba(0, 0, 0, 0.1), 0 20px 25px -5px rgba(0, 0, 0, 0.04)',
        'neumorphic': 'inset 8px 8px 16px #d1d5db, inset -8px -8px 16px #ffffff',
      ...
      animation: {
        ...
        'progress-ring': 'progressRing 1.5s ease-in-out infinite',
